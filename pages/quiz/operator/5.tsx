...
export default function PageQuizOperator5() {
  ...
  function showHint() {
    alert('Operator logika: "or", "and", atau "not"');
  }
  return (
    <>
      <Header>
                ...
                <span className="text-blue-900">
                  ...
                  <div className="pl-2 mt-3">
                    ...
                    <div className="ml-4">
                      ...
                      <li>
                        <Link href={"/quiz/operator/5"} className="font-bold">
                          Quiz 5
                        </Link>
                      </li>
                    </div>
            ...
            <div className="mt-4 gap-2 bg-neutral-200 p-4 rounded-md">
              <div className="flex flex-col">
                <code className="text-sm sm:text-md">
                  if (9==8 <input type="text" className="w-8" id="jawaban" />{" "}
                  10==10)&#58;
                </code>
                <code className="text-sm sm:text-md">
                ...
                <p className="mt-5">
                  Ketikkan operator logika yang membolehkan salah satu
