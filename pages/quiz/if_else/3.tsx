...
export default function PageQuizIfElse3() {
  ...
  function checkAnswers() {
    ...
    const jawaban3 = (document.getElementById("jawaban3") as HTMLInputElement)
      .value;
    const jawaban4 = (document.getElementById("jawaban4") as HTMLInputElement)
      .value;
    const jawaban5 = (document.getElementById("jawaban5") as HTMLInputElement)
      .value;
  ...
  return (
    <>
      ...
      <section className="p-4">
        <h1 className="text-2xl font-semibold">Quiz if ... else</h1>
          ...
          <div className="flex flex-col">
            <code>
              <span className="text-red-700">
                <input type="text" id="jawaban1" className="w-6" />
              </span>{" "}
              &#40;a &#62; b&#41;
              <input type="text" id="jawaban2" className="w-4" />
            </code>
            <code>
            ...
            <code>
              <span className="text-red-700">
                <input type="text" id="jawaban3" className="w-10" />
              </span>{" "}
              &#40;a &#60; b&#41;
              <input type="text" id="jawaban4" className="w-4" />
            </code>
            <code>
              &nbsp;<span className="text-violet-700">print </span>
              &#40;
            ...
            <code>
              <span className="text-red-700">
                <input type="text" id="jawaban5" className="w-10" />
              </span>
              &#58;
            </code>
            <code>
              &nbsp;<span className="text-violet-700">print </span>
              &#40;
              <span className="text-orange-700">&#34;a sama dengan b&#34;</span>
              &#41;
            </code>
            <p className="mt-10">
              Lengkapi kode diatas dengan{" "}
              <code className="bg-neutral-300 px-1 rounded-sm text-sm sm:text-md text-red-700">
                if
              </code>
              {", "}
              <code className="bg-neutral-300 px-1 rounded-sm text-sm sm:text-md text-red-700">
