...
export default function PageQuizIfElse4() {
                ...
                <span className="text-blue-900">
                  ...
                  <div className="pl-2 mt-3">
                    ...
                    <div className="ml-4">
                      ...
                      <li>
                        <Link href={"/quiz/if_else/4"} className="font-bold">
                          Quiz 4
                        </Link>
                      </li>
                      <li>
          ...
          <div className="md:col-span-8 md:max-h-screen md:overflow-y-auto p-4">
            ...
            <div className="mt-4 gap-2 bg-neutral-200 p-4 rounded-md">
              <div className="flex flex-col">
                ...
                <code>
                  <span className="text-red-700">if</span> &#40;x &#62;
                  0&#41;&#58;
                </code>
                <code>
                  &nbsp;<span className="text-violet-700">print </span>
                  &#40;
                  <span className="text-orange-700">&#34;Halo&#34;</span>
                  &#41;
                </code>
                <code>
                  <span className="text-red-700">elif</span> &#40;x &#60;
                  0&#41;&#58;
                </code>
                <code>
                  &nbsp;<span className="text-violet-700">print </span>
                  &#40;
                  <span className="text-orange-700">&#34;Hai&#34;</span>
                  &#41;
                </code>
                <code>
                ...
                <code>
                  &nbsp;<span className="text-violet-700">print </span>
                  &#40;
                  <span className="text-orange-700">&#34;Hola&#34;</span>
                  &#41;
                </code>
                <p className="mt-7">
                  Menurut kalian, output apakah yang akan ditampilkan di
                  terminal?
                  <br />
                </p>
              </div>
              <code>
                <input type="text" className="mt-3 w-20" id="jawaban1" />
              </code>
              <div className="mt-10">
                <button
