...
export default function PageQuizIfElse1() {
              ...
              <div>
                <span className="text-blue-900">
                  ...
                  <div className="pl-2 mt-3">
                    ...
                    <div className="ml-4">
                      <li>
                        <Link href={"/quiz/if_else/1"} className="font-bold">
                          Quiz 1
                        </Link>
                      </li>
                      <li>
          ...
          <div className="md:col-span-8 md:max-h-screen md:overflow-y-auto p-4">
            ...
            <div className="mt-4 gap-2 bg-neutral-200 p-4 rounded-md">
              <div className="flex flex-col">
                <code>
                  x &#61; <span className="text-red-700">10</span>
                </code>
                <code>
                  <br />
                ...
                <code>
                  <span className="text-red-700">
                    <input type="text" id="jawaban2" className="w-12" />
                  </span>
                  &#58;
                </code>
                <code>
                ...
                <p className="mt-10">
                  Lengkapi kode diatas dengan <code>if</code> dan{" "}
                  <code>else</code> yang benar.
                </p>
              </div>
              <div className="mt-10">
                <button
