...
export default function PageQuizIfElse2() {
  ...
  function checkAnswers() {
    ...
    //checking answer
    if (jawaban1 == "if" && jawaban2 == "and" && jawaban3 == ":") {
                ...
                <span className="text-blue-900">
                  ...
                  <div className="pl-2 mt-3">
                    ...
                    <div className="ml-4">
                      ...
                      <li>
                        <Link href={"/quiz/if_else/2"} className="font-bold">
                          Quiz 2
                        </Link>
                      </li>
                      <li>
            ...
            <div className="mt-4 gap-2 bg-neutral-200 p-4 rounded-md">
              <div className="flex flex-col">
                <code>
                  ...
                  &#40;a &#61;&#61; b&#41;{" "}
                  <span className="text-red-700">
                    <input type="text" id="jawaban2" className="w-8" />
                  </span>{" "}
                  &#40;b &#61;&#61; c&#41;
                  <input type="text" id="jawaban3" className="w-4" />
                </code>
                <code>
                  &nbsp;<span className="text-violet-700">print </span>
                  &#40;
                  <span className="text-orange-700">&#34;Hello world&#34;</span>
                  &#41;
                </code>
                <p className="mt-10">
                  Lengkapi kode diatas agar ketika{" "}
                  <code className="px-1 bg-neutral-300 text-sm sm:text-md rounded-sm">
                    &#40;a &#61;&#61; b&#41;
                  </code>{" "}
                  dan{" "}
                  <code className="px-1 bg-neutral-300 text-sm sm:text-md rounded-sm">
