...
export default function PageQuizList4() {
                ...
                <span className="text-blue-900">
                  ...
                  <div className="pl-2 mt-3">
                    ...
                    <div className="ml-4">
                      ...
                      <li>
                        <Link href={"/quiz/list/4"} className="font-bold">
                          Quiz 4
                        </Link>
                      </li>
                      <li>
            ...
            <div className="mt-4 gap-2 bg-neutral-200 p-4 rounded-md">
              <div className="flex flex-col">
                ...
                <div className="mt-3">
                  <code>
                    print(
                    <input type="text" id="jawaban1" className="w-24" />)
                  </code>
                </div>
                <p className="mt-5">
                  Lengkapi kode diatas untuk menampilkan jumlah data dalam list.
                </p>
              </div>
