...
export default function PageQuizList1() {
  ...
  function showHint() {
    alert('Gunakan metode indexing! Perhatikan contoh: \nbuah[0] = "Jeruk"');
  }
  return (
    <>
      <Header>
              ...
              <div>
                <span className="text-blue-900">
                  ...
                  <div className="pl-2 mt-3">
                    ...
                    <div className="ml-4">
                      <li>
                        <Link href={"/quiz/list/1"} className="font-bold">Quiz 1</Link>
                      </li>
                      <li>
              ...
              <div className="flex flex-col">
                ...
                <div className="mt-3">
                  <code>
                    ...
                    &#34;
                    <input type="text" id="jawaban2" className="w-20" />
                    &#34;
                  </code>
                </div>
                <p className="mt-5">
                  Gantilah data Fiat dalam list diatas menjadi Honda.
                </p>
              </div>
