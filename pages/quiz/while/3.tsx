...
export default function PageQuizWhile3() {
      ...
      <section className="">
        <div className="md:grid md:grid-cols-12">
                ...
                <span className="text-blue-900">
                  ...
                  <div className="pl-2 mt-3">
                    ...
                    <div className="ml-4">
                      ...
                      <li>
                        <Link href={"/quiz/while/3"} className="font-bold">
                          Quiz 3
                        </Link>
                      </li>
                    </div>
          ...
          <div className="md:col-span-8 md:max-h-screen md:overflow-y-auto p-4">
            <h1 className="text-2xl font-semibold">Quiz while</h1>
            ...
            <div className="mt-4 gap-2 bg-neutral-200 p-4 rounded-md">
              <div className="flex flex-col">
                ...
                <code>
                  <br />
                  <span className="text-red-700">while</span> &#40;i &#60;
                  7&#41;&#58;
                </code>
                <code>&nbsp;i &#43;&#61; 1</code>
                <code>
                  &nbsp;<span className="text-red-700">if</span> i &#61;&#61;
                  3&#58;
                </code>
                <code>
                  &nbsp;&nbsp;
                ...
                <p className="mt-7">
                  Lengkapi perulangan while diatas dengan syarat ketika nilai{" "}
                  <code className="bg-neutral-300 px-1 rounded-sm text-red-700 text-sm sm:text-md">
                    i &#61; 3
                  </code>{" "}
                  perintah print dilewati dan dilanjutkan ke perintah
                  selanjutnya.
                </p>
              </div>
              <div className="mt-10">
