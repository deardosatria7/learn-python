...
export default function PageQuizFor1() {
      ...
      <section className="">
        <div className="md:grid md:grid-cols-12">
                ...
                <span className="text-blue-900">
                  ...
                  <div className="pl-2 mt-3 mb-20">
                    ...
                    <div className="ml-4">
                      ...
                      <li>
                        <Link href={"/quiz/for/3"} className="font-bold">
                          Quiz 3
                        </Link>
                      </li>
                    </div>
          ...
          <div className="md:col-span-8 md:max-h-screen md:overflow-y-auto p-4">
            <h1 className="text-2xl font-semibold">Quiz For</h1>
            ...
            <div className="mt-4 gap-2 bg-neutral-200 p-4 rounded-md">
              <div className="flex flex-col">
                ...
                <code>
                  <br />
                  <span className="text-red-700">for</span> data{" "}
                  <span className="text-red-700">in</span> merk&#58;
                </code>
                <code>
                  &nbsp;
                  <span className="text-red-700">for</span> i{" "}
                  <span className="text-red-700">in</span> range&#40;1,
                  4&#41;&#58;
                </code>
                <code>
                ...
                <p className="mt-7">
                  Lengkapi perulangan for dalam for diatas untuk menampilkan
                  seluruh data dalam merk beserta dengan{" "}
                  <code className="text-sm sm:text-md bg-neutral-300 rounded-sm text-red-700">
                    i
                  </code>
                  .
                </p>
