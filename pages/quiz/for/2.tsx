...
export default function PageQuizFor2() {
  ...
  function checkAnswers() {
    ...
    //checking answer
    if (jawaban1 == "for" && jawaban2 == "range") {
          ...
          <div className="flex flex-col">
            <code>
              <span className="text-red-700">
                <input type="text" id="jawaban1" className="w-8" />
              </span>{" "}
              i <span className="text-red-700">in</span>{" "}
              <input type="text" id="jawaban2" className="w-14" />
              &#40;5&#41;&#58;
            </code>
            <code>
              &nbsp;<span className="text-violet-700">print</span>&#40;i&#41;
            </code>
            <p className="mt-7">
              Lengkapi perulangan for diatas dengan metode{" "}
              <code className="px-1 bg-neutral-300 rounded-sm text-red-700">
                range()
              </code>
              .
            </p>
