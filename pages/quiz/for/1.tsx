        ...
        <div className="mt-4 gap-2 bg-neutral-200 p-4 rounded-md">
          <div className="flex flex-col">
            ...
            <code>
              ...
              data <span className="text-red-700">in</span> merk&#58;
            </code>
            <code>
              &nbsp;<span className="text-violet-700">print</span>&#40;data&#41;
            </code>
            <p className="mt-7">
              Lengkapi perulangan for diatas untuk menampilkan seluruh data
              dalam merk.
            </p>
          </div>
          <div className="mt-10">
