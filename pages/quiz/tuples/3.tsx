...
export default function PageQuizTuples3() {
  ...
  function showHint() {
    alert('Perhatikan contoh berikut! \nmobil.index("BMW")');
  }
  return (
    <>
      <Header>
                ...
                <span className="text-blue-900">
                  ...
                  <div className="pl-2 mt-3">
                    ...
                    <div className="ml-4">
                      ...
                      <li>
                        <Link href={"/quiz/tuples/3"} className="font-bold">Quiz 3</Link>
                      </li>
                      <li>
            ...
            <div className="mt-4 gap-2 bg-neutral-200 p-4 rounded-md">
              <div className="flex flex-col">
                <code className="text-sm sm:text-md">
                  buah = &#40;
                  <span className="text-orange-700">&#34;kiwi&#34;</span>,{" "}
                ...
                <p className="mt-10">
                  Buatlah agar x bernilai posisi/urutan dari data{" "}
                  <code className="bg-neutral-300 text-orange-700 px-1 rounded-sm">
                    &#34;apel&#34;
                  </code>{" "}
                  pada tuple diatas.
                </p>
