...
export default function PageQuizDict3() {
  ...
  function showHint() {
    alert('Contoh metode pop: buah.pop("apel")');
  }
  return (
    <>
      <Header>
                ...
                <span className="text-blue-900">
                  ...
                  <div className="pl-2 mt-3">
                    ...
                    <div className="ml-4">
                      ...
                      <li>
                        <Link href={"/quiz/dictionary/3"} className="font-bold">
                          Quiz 3
                        </Link>
                      </li>
                      <li>
            ...
            <div className="mt-4 gap-2 bg-neutral-200 p-4 rounded-md">
              <div className="flex flex-col">
                ...
                <p className="mt-10">
                  ...
                  <code className="bg-neutral-300 px-1 text-red-600">
                    pop()
                  </code>
                  .
                </p>
