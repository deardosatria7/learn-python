...
export default function PageQuizDict1() {
  ...
  function showHint() {
    alert('Contoh untuk tahun: mobil["tahun"]');
  }
  return (
    <>
      <Header>
              ...
              <div>
                <span className="text-blue-900">
                  ...
                  <div className="pl-2 mt-3">
                    ...
                    <div className="ml-4">
                      <li>
                        <Link href={"/quiz/dictionary/1"} className="font-bold">
                          Quiz 1
                        </Link>
                      </li>
                      <li>
          ...
          <div className="md:col-span-8 md:max-h-screen md:overflow-y-auto p-4">
            ...
            <div className="mt-4 gap-2 bg-neutral-200 p-4 rounded-md">
              <div className="flex flex-col">
                ...
                <p className="mt-10">
                  Lengkapi kode diatas untuk menampilkan model dari mobil
                  tersebut.
                </p>
              </div>
