...
export default function PageQuizSet5() {
  ...
  function showHint() {
    alert("Gunakan perulangan for untuk kasus ini.");
  }
  return (
    <>
      <Header>
                ...
                <span className="text-blue-900">
                  ...
                  <div className="pl-2 mt-3">
                    ...
                    <div className="ml-4">
                      ...
                      <li>
                        <Link href={"/quiz/set/5"} className="font-bold">
                          Quiz 5
                        </Link>
                      </li>
                    </div>
          ...
          <div className="md:col-span-8 md:max-h-screen md:overflow-y-auto p-4">
            ...
            <div className="mt-4 gap-2 bg-neutral-200 p-4 rounded-md">
              <div className="flex flex-col">
                ...
                <code className="text-sm sm:text-md mt-5">
                  <input type="text" id="jawaban1" className="w-8" /> data{" "}
                  <span className="text-red-700">in</span> merk:
                </code>
                <code className="text-sm sm:text-md">
                  &nbsp;print(
                  <input type="text" id="jawaban2" className="w-10" />)
                </code>
                <p className="mt-10">
                  Lengkapi kode diatas untuk menampilkan seluruh data dalam set.
                </p>
              </div>
              <div className="mt-10">
                <button
