...
export default function PageQuizSet3() {
  ...
  function showHint() {
    alert("Contoh: list1.update(list2)");
  }
                ...
                <span className="text-blue-900">
                  ...
                  <div className="pl-2 mt-3">
                    ...
                    <div className="ml-4">
                      ...
                      <li>
                        <Link href={"/quiz/set/3"} className="font-bold">
                          Quiz 3
                        </Link>
                      </li>
                      <li>
          ...
          <div className="md:col-span-8 md:max-h-screen md:overflow-y-auto p-4">
            ...
            <div className="mt-4 gap-2 bg-neutral-200 p-4 rounded-md">
              <div className="flex flex-col">
                ...
                <p className="mt-10">
                  Coba masukkan data set2 kedalam set1 dengan metode{" "}
