...
export default function PageQuizSet2() {
  ...
  function showHint() {
    alert('Contoh: buah.discard("apel")');
  }
                ...
                <span className="text-blue-900">
                  ...
                  <div className="pl-2 mt-3">
                    ...
                    <div className="ml-4">
                      ...
                      <li>
                        <Link href={"/quiz/set/2"} className="font-bold">
                          Quiz 2
                        </Link>
                      </li>
                      <li>
            ...
            <div className="mt-4 gap-2 bg-neutral-200 p-4 rounded-md">
              <div className="flex flex-col">
                ...
                <code className="mt-1 text-sm sm:text-md">
                  <input type="text" id="jawaban1" className="w-40" />{" "}
                </code>

                <p className="mt-10">
                  Coba hapus data{" "}
                  <code className="text-sm sm:text-md px-1 bg-neutral-300 text-orange-700">
                    &#34;asus&#34;
                  </code>{" "}
                  pada set diatas dengan metode{" "}
