        ...
        <div className="md:grid md:grid-cols-12">
          ...
          <div className="md:col-span-8 md:max-h-screen md:overflow-y-auto p-4">
            ...
            <p className="pt-3 pl-1">
              Untuk menghapus data tertentu dalam sebuah set, kita dapat
              menggunakan metode <b>discard()</b> dan <b>remove()</b>.
            </p>
            <p className="pt-3 pl-1">
              Kedua metode tersebut memiliki fungsi yang mirip. Namun metode{" "}
              <code className="bg-neutral-200 py-1 rounded-md">remove()</code>{" "}
              akan menampilkan error apabila data tersebut tidak ada dalam set.
            </p>
            ...
            <p className="pt-6 pl-1">
              ...
              tidak akan menampilkan error ketika data tersebut tidak ada dalam
              set.
            </p>
            <div className="pt-3 text-sm sm:text-md">
              <div className="flex flex-col">
            ...
            <p className="py-2 pl-1 pt-10">
              Metode{" "}
              <code className="bg-neutral-200 px-1 rounded-sm">clear()</code>{" "}
            ...
            <p className="py-2 pl-1 pt-10">
              ...
              berfungsi dalam menghapus sebuah variabel yang berupa set
              tersebut.
            </p>
            <div className="text-sm sm:text-md">
              <div className="flex flex-col">
            ...
            <div className="pl-1 pt-10 pb-20 md:pb-10">
