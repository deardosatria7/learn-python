    ...
    <>
      <Header>
        <div className="flex flex-row justify-start gap-4">
          ...
          <Link href={"/"}>
            <h4 className="ml-2 text-lg text-white">Belajar-Python</h4>
          </Link>
        </div>
      </Header>
      <section className="">
        <div className="md:grid md:grid-cols-12">
          ...
          <div className="md:col-span-8 p-4">
            ...
            <p className="pt-3 pl-1">
              Python merupakan merupakan salah satu bahasa pemrograman paling
              banyak digunakan di dunia internasional. Bagian yang unik dari
              bahasa python adalah sifatnya yang interpretatif. Python
              menekankan pada keterbacaan kode agar lebih mudah dipahami.
            </p>
            <p className="pt-3 pl-1">
              Sehingga bahasa pemrograman python mudah dibaca oleh pemula dan
              dapat digunakan para ahli dalam otomasi tugas, pembuatan game,
              analisis data, <i>machine learning</i>, dan masih banyak lagi.
            </p>
            <p className="pt-3 pl-1">
              Berikut ini adalah contoh bahasa pemrograman python, mari kita
