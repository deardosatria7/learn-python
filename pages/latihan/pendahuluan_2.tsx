        ...
        <div className="md:grid md:grid-cols-12">
          ...
          <div className="md:col-span-8 p-4">
            ...
            <p className="pt-3 pl-1">
              ...
              menyimpan data dalam bentuk variabel untuk kemudian dapat
              digunakan ulang dalam operasi lainnya.
            </p>
            <p className="pt-3 pl-1">
              Seperti contoh dibawah ini, kita akan menghitung diskon 50&#37;
              dari harga tersebut. Perhatikan contoh dibawah!
            </p>
