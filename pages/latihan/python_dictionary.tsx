        ...
        <div className="md:grid md:grid-cols-12">
          ...
          <div className="md:col-span-8 md:max-h-screen md:overflow-y-auto p-4">
            ...
            <p className="py-3 pl-1">
              <b>Dictionary</b> digunakan untuk menyimpan data dalam bentuk
              pasangan <i>key</i> dan <i>value</i>. Perhatikan contoh dibawah
              ini.
            </p>
              ...
              <div className="flex flex-col">
                <div className="bg-neutral-200 p-2 rounded-md">
                  <div>
                    ...
                    <br />
                    <code>
                      <span className="text-violet-700">print</span>(dict1)
                    </code>
                  </div>
            ...
            <div className="pl-3">
              <ul className="pl-4">
                <li className="list-item list-decimal">
                  Dictionary mengizinkan update data (menambahkan, menghapus,
                  dan mengedit).
                </li>
                ...
                <li className="list-item list-decimal pt-1">
                  Sebuah dictionary dapat menyimpan berbagai macam tipe data,
                  dalam bentuk berpasangan antara <i>key</i> dan <i>value</i>.
                </li>
                <li className="list-item list-decimal pt-1">
