      ...
      <section className="">
        <div className="md:grid md:grid-cols-12">
          ...
          <div className="md:col-span-8 md:max-h-screen md:overflow-y-auto p-4">
              ...
              <div className="flex flex-col">
                <div className="bg-neutral-200 p-2 rounded-md">
                  <div>
                    <code>
                      <span className="text-violet-800">for</span> x{" "}
                      <span className="text-red-700">in range</span>(2, 30,
                      3)&#58;
                    </code>
                    <br />
                    &nbsp;
            ...
            <div className="text-lg font font-semibold mt-12">
              For dengan else
            </div>
            ...
            <p className="py-2 pl-1 pt-3">
              Kalian juga dapat memasukkan metode for didalam sebuah for lain.
