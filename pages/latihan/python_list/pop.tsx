    ...
    <>
      ...
      <section className="p-4">
        ...
        <div className="text-lg font-semibold pt-3 pl-1">
          Metode <code>pop()</code>
        </div>
        <div className="flex flex-col pl-1">
          <div className="pt-3">
            Metode pop( ) digunakan untuk menghapus data didalam list. Metode
            ini mengharuskan kalian untuk menyebutkan posisi data yang akan
            dihapus.
          </div>
          <div className="pt-3">
            Metode pop( ) dapat digunakan dengan format{" "}
