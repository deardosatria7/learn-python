...
const code =
  'mobil1 = ["Fiat", "BMW", "Toyota"] \nmobil2 = ["VW", "Audi"] \nmobil1.extend(mobil2) \nprint(mobil1)';
    ...
    <>
      ...
      <section className="p-4">
        ...
        <div className="text-lg font-semibold pt-3 pl-1">
          Metode <code>extend()</code>
        </div>
        <div className="flex flex-col pl-1">
          <div className="pt-3">
            Metode extend( ) digunakan untuk menambahkan data baru kedalam list.
            Data yang ditambahkan disini berupa list lainnya.
          </div>
          <div className="pt-3">
            Metode extend( ) dapat digunakan dengan format{" "}
            <code className="px-2 py-1 rounded-md bg-neutral-200 text-sm sm:text-md">
              <i>namaList1.</i>extend(<i>namaList2</i>)
            </code>{" "}
          </div>
        </div>
        <div className="pt-6">
          <div className="flex flex-col">
            <div className="bg-neutral-200 p-2 rounded-md text-sm sm:text-md">
              <div>
                ...
                <code>
                  mobil2 = [
                  <span className="text-orange-700">&#34;VW&#34;</span>,{" "}
                  <span className="text-orange-700">&#34;Audi&#34;</span>]
                </code>
                <br />
                <br />
                <code>mobil1.extend(mobil2)</code>
                <br />
                <code>
                  <span className="text-violet-800">print</span>(mobil1)
                </code>
              </div>
