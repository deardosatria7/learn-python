    ...
    <>
      ...
      <section className="p-4">
        ...
        <div className="text-lg font-semibold pt-3 pl-1">
          Metode <code>insert()</code>
        </div>
        <div className="flex flex-col pl-1">
          <div className="pt-3">
            Metode insert( ) digunakan untuk menambahkan data baru kedalam list.
            Metode ini mengharuskan kalian untuk menyebutkan posisi data
            tersebut akan ditaruh dimana.
          </div>
          <div className="pt-3">
            Metode insert( ) dapat digunakan dengan format{" "}
