    ...
    <>
      ...
      <section className="p-4">
        ...
        <div className="text-lg font-semibold pt-3 pl-1">
          Metode <code>remove()</code>
        </div>
        <div className="flex flex-col pl-1">
          <div className="pt-3">
            Metode remove( ) digunakan untuk menghapus data didalam list. Metode
            ini mengharuskan kalian untuk menyebutkan data yang akan dihapus.
          </div>
          <div className="pt-3">
            Metode remove( ) dapat digunakan dengan format{" "}
            <code className="px-2 py-1 rounded-md bg-neutral-200 text-sm sm:text-md">
              <i>namaList.</i>remove(&#34;<i>data</i>&#34;)
            </code>{" "}
          </div>
        </div>
        <div className="pt-6">
