        ...
        <div className="md:grid md:grid-cols-12">
          ...
          <div className="md:col-span-8 p-4">
            ...
            <p className="pt-3 pl-1">
              ...
              terhadap keanggotaan dalam sebuah kumpulan data. Operator ini
              terdiri dari:
            </p>
            <div className="pt-3 pl-1">
              <b>in</b>: Bernilai <i>True</i> apabila data yang dicek berada
              dalam kumpulan data.
              <br />
              <b>not in</b>: Bernilai <i>True</i> apabila data yang diperiksa
              tidak ada dalam kumpulan data.
              <br />
            </div>
            <div className="pt-3 pl-1">
