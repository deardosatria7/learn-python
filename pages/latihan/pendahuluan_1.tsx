        ...
        <div className="md:grid md:grid-cols-12">
          ...
          <div className="md:col-span-8 p-4">
            ...
            <p className="pt-3 pl-1">
              Bagus! Kalian telah mencoba menjalankan program python pertama
              kalian. Sekarang mari kita coba untuk memahami kode python
              tersebut.
            </p>
            <p className="pt-3 pl-1">
              Di dalam Python, kita dapat menyimpan sebuah nilai di dalam sebuah{" "}
              <b>variabel.</b> Dibawah ini merupakan contoh variabel yang
              berbentuk <b>integer</b>.
            </p>
