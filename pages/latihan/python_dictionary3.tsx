        ...
        <div className="md:grid md:grid-cols-12">
          ...
          <div className="md:col-span-8 md:max-h-screen md:overflow-y-auto p-4">
            ...
            <p className="py-3 pl-1">
              Kalian dapat mengupdate data dalam dictionary dengan menggunakan
            ...
            <p className="py-2 pl-1 pt-6">
              ...
              , yaitu metode yang mengharuskan kalian untuk menginputkan nilai
              key dan value-nya. Perhatikan contoh di bawah ini.
            </p>
            <div className="pt-3 text-sm sm:text-md">
              <div className="flex flex-col">
                <div className="bg-neutral-200 p-2 rounded-md">
