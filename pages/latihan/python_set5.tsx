      ...
      <section className="">
        <div className="md:grid md:grid-cols-12">
          ...
          <div className="md:col-span-8 md:max-h-screen md:overflow-y-auto p-4">
              ...
              <table className="table-auto border-2">
                <tbody>
                  ...
                  <tr className="flex justify-start content-start gap-1 p-2">
                    ...
                    <td>
                      Menghapus item yang ada di kedua set, dan masukkan item
                      yang tidak ada di kedua set.
                    </td>
                  </tr>
                  <tr className="flex justify-start content-start gap-1 p-2">
                  ...
                  <tr className="flex justify-start content-start gap-1 p-2 bg-neutral-100">
                    ...
                    <td>
                      Mengembalikan set yang berisikan data yang terdapat pada
                      set pertama dan set kedua.
                    </td>
                  </tr>
                  <tr className="flex justify-start content-start gap-1 p-2">
                    ...
                    <td>
                      Menghapus data yang tidak ada pada set pertama dan set
                      kedua.
                    </td>
                  </tr>
                  <tr className="flex justify-start content-start gap-1 p-2">
                    ...
                    <td>
                      Mengembalikan nilai True apabila terdapat data yang sama
                      dalam kedua buah set.
                    </td>
                  </tr>
                  <tr className="flex justify-start content-start gap-1 p-2 bg-neutral-100">
                    ...
                    <td>
                      Mengembalikan nilai True apabila seluruh data pada set
                      kedua ada pada set pertama.
                    </td>
                  </tr>
                  <tr className="flex justify-start content-start gap-1 p-2">
            ...
            <p className="pt-6 pl-1 pb-20 md:pb-10">
              Kalian dapat meng-klik pada metode yang ingin dipelajari pada
              bagian diatas.
            </p>
