        ...
        <div className="md:grid md:grid-cols-12">
          ...
          <div className="md:col-span-8 md:max-h-screen md:overflow-y-auto p-4">
            ...
            <p className="py-3 pt-4 pl-1">
              Terdapat cara lebih singkat untuk menulis pengulangan if.
            ...
            <p className="pl-1 pt-5">
              ...
              <span className="italic font-semibold">Ternary Operators</span>{" "}
              atau{" "}
            ...
            <p className="pl-1 mt-20">
              ...
              <b>NOT</b> kedalam pengulangan if. Hal ini dilakukan apabila
              terdapat dua kondisi yang harus dipenuhi dalam satu blok if.
              ...
              <div className="flex flex-col">
                <div className="bg-neutral-200 p-2 rounded-md">
                  ...
                  <code>
                    ...
                    <span className="text-orange-700">and</span> x &#60;
                    y&#41;&#58;
                  </code>
                  <br />
                  &nbsp;
