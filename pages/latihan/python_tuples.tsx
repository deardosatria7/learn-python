        ...
        <div className="md:grid md:grid-cols-12">
          ...
          <div className="md:col-span-8 md:max-h-screen md:overflow-y-auto p-4">
            ...
            <p className="py-3 pl-1">
              <b>Tuple</b> digunakan untuk menyimpan berbagai nilai/data dalam
              satu variabel. Tuple ditandai dengan{" "}
              <b>tanda kurung &#40; &#41;.</b>
            </p>
            ...
            <p className="py-2 pl-1 pt-6">
              Di dalam tuple, tipe data yang disimpan dapat berbeda satu sama
              lain, mengizinkan dua nilai yang sama, dan disimpan secara
              berurutan.
            </p>
            <code className="ml-1 px-2 py-1 rounded-md bg-neutral-200">
              tuple2 &#61; &#40;
            ...
            <div className="pl-3 pt-2 pb-20 md:pb-12">
              <ul className="pl-4">
