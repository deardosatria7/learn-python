    ...
    <>
      ...
      <section className="p-4">
        ...
        <p className="py-3 pl-1">
          Data di dalam sebuah tuple tidak dapat diubah. Hal ini berarti kita{" "}
          <b>tidak dapat menambahkan, mengganti,</b> ataupun{" "}
          <b>menghapus data</b> di dalam sebuah tuple.
        </p>
        <p className="py-2 pl-1 pt-2">
          Dalam memilih tipe data, perlu diketahui terlebih dahulu karakteristik
          dari tipe data tersebut. Agar program menjadi lebih efisien dan bisa
          juga meningkatkan faktor keamanan data.
        </p>
        <p className="py-2 pl-1 pt-2 pb-4">
          Namun, terdapat cara untuk mengupdate data dalam sebuah tuple. Yaitu
          dengan mengubahnya menjadi list.
        </p>
