      ...
      <section className="">
        <div className="md:grid md:grid-cols-12">
          ...
          <div className="md:col-span-8 p-4">
            ...
            <p className="pt-3 pl-1">
              Di bawah ini terdapat dua buah variabel bernama nomor_1 dan
              nomor_2. Keduanya bernilai sama dengan 50. Kita akan membandingkan
            ...
            <p className="pt-3 pl-1 mb-20 md:mb-14">
