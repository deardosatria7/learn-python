        ...
        <div className="md:grid md:grid-cols-12">
          ...
          <div className="md:col-span-8 md:max-h-screen md:overflow-y-auto p-4">
            ...
            <p className="py-3 pl-1">
              Menghapus data di dalam dictionary dapat dilakukan dengan
              menggunakan metode{" "}
              <code className="px-1 bg-neutral-200 rounded-sm">pop()</code>.
              Metode ini akan menghilangkan key tertentu beserta dengan
              valuenya.
            </p>
