        ...
        <div className="md:grid md:grid-cols-12">
          ...
          <div className="md:col-span-8 md:max-h-screen md:overflow-y-auto p-4">
            ...
            <div className="text-lg font-semibold pt-3 pl-1">
              Mengakses data dalam set
            </div>
            <p className="pt-3 pl-1">
              Data dalam set tidak bisa diakses seperti halnya list dan tuple.
              Hal ini dikarenakan data dalam set tidak memiliki urutan.
            </p>
            <p className="pt-3 pl-1">
              Bagaimanapun, kalian dapat mengakses data dalam set dengan
              menggunakan pengulangan <b>for</b> seperti dibawah ini.
            </p>
