    ...
    <>
      ...
      <section className="p-4">
        ...
        <div className="text-lg font-semibold pt-3 pl-1">
          Metode <code>symmetric_difference_update()</code>
        </div>
        <p className="pt-3 pl-1">
          ...
          digunakan untuk mengupdate dengan menghapus data yang terdapat pada
          kedua buah set, dan memasukkan data lainnya.
        </p>
