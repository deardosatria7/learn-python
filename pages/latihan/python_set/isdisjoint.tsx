    ...
    <>
      ...
      <section className="p-4">
        ...
        <div className="text-lg font-semibold pt-3 pl-1">
          Metode <code>isdisjoint()</code>
        </div>
        <p className="pt-3 pl-1">
          Metode{" "}
          <code className="bg-neutral-200 py-1 rounded-md">isdisjoint()</code>{" "}
          digunakan untuk mengecek data dari kedua set yang berbeda. Apabila
          tidak ada data yang sama maka akan mengembalikan nilai True, dan
          sebaliknya.
        </p>
            ...
            <div className="bg-neutral-200 p-2 rounded-md">
              <div>
                ...
                <code>
                  set2 &#61; &#123;
                  <span className="text-orange-700">&#34;apple&#34;</span>,{" "}
                  <span className="text-orange-700">&#34;mango&#34;</span>,{" "}
                  <span className="text-orange-700">&#34;banana&#34;</span>
                  &#125;
                </code>
                <br />
                <br />
                <code>x = set1.isdisjoint(set2)</code>
                <br />
                <code>
